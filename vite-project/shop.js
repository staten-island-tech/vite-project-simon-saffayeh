...
currentUrl = currentUrl.split("html/",2)[1]
console.log(currentUrl)
let breadcrumbs = currentUrl.split("/").filter(Boolean); // Split URL and remove empty elements
let lastbreadcrumb = breadcrumbs[breadcrumbs.length - 1];
//alert(document.getElementById("title-text"))
//document.getElementById("title-text").innerHTML = capitalizeFirstLetter(lastbreadcrumb)
...
//debug inner html title
//fix navbar reroute to home